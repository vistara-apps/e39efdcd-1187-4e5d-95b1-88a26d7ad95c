  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 via-blue-500 to-purple-600 p-4">
      <div className="text-center">
        <div className="w-16 h-16 bg-red-500 bg-opacity-20 rounded-full flex items-center justify-center mb-6 mx-auto">
        ...
        <p className="text-white text-opacity-80 mb-6 max-w-md">
          We encountered an error while loading PayNoti. Please try again.
        </p>
        <button
          onClick={reset}
